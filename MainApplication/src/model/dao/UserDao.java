...
public class UserDao {
    ...
    private static final String logoutQuery = "UPDATE user SET isOnline=0 WHERE id=?;UPDATE online_history SET logoutDatetime=? WHERE id=(SELECT id FROM online_history oh WHERE oh.User_id=? ORDER BY oh.loginDatetime DESC LIMIT 1)";
